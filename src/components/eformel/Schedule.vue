...
<script>
  ...
  export default {
    ...
    mounted() {
      if(localStorage.EFormelSchedule) {
        this.objects = JSON.parse(localStorage.getItem('EFormelSchedule'));
      }
      else {
        this.createList()
      }

      if(localStorage.EFormelScheduleVenue) {
        this.venue.title = JSON.parse(localStorage.getItem('EFormelSchedule')).title;
        this.venue.subline = JSON.parse(localStorage.getItem('EFormelSchedule')).subline;
        this.venue.country = JSON.parse(localStorage.getItem('EFormelSchedule')).country;
      }
      else {
    ...
    methods: {
      ...
      persistObjects(objects) {
        localStorage.setItem('EFormelSchedule', JSON.stringify(objects))
      },
      persistVenue(venue) {
        localStorage.setItem('EFormelScheduleVenue', JSON.stringify(venue))
      }
    },
    computed: {
      cssVars() {
